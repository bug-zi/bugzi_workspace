...
> 本文档由 AI 基于 `docs/project/左侧边栏/生活模块/致知己/design.md`（260905 开发者审核通过）与《总需求文档.md》生成，是开发的直接依据。覆盖三块：①致知己模块本体 ②个人档「我的画像」 ③右侧 AI 边栏「频道制」改造。依赖：样式/designs-specs.md 的 AI 边栏与 MdDialog、回收站/designs-specs.md 的接入约定。
