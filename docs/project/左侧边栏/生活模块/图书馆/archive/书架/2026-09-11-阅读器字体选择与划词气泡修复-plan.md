...
**Tech Stack:** Electron 44 + React 19 + TypeScript + epub.js（rendition/themes/annotations）。设计文档：`docs/project/左侧边栏/生活模块/图书馆/archive/书架/2026-09-11-阅读器字体选择与划词气泡修复-design.md`（含根因取证，实施前先通读）。
