...
> 本文档由 AI 基于 `docs/project/左侧边栏/生活模块/灵感泉/design.md` 与《总需求文档.md》第 1、5、6 条生成，是开发的直接依据。依赖：样式/designs-specs.md 的 MdDialog、MdView、回收站/designs-specs.md 的接入约定。§6 为 v2.0 增量（AI 辅助生成灵感，260903 设计定稿）。
>
