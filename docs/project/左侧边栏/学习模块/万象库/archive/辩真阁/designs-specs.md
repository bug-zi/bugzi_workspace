...
> 本文档由 AI 基于 `docs/project/左侧边栏/学习模块/万象库/archive/辩真阁/design.md` 与《总需求文档.md》第 1、5、6、8 条生成，是开发的直接依据。依赖：样式/designs-specs.md 的 AI 边栏与 MdDialog、回收站/designs-specs.md 的接入约定、个人档的 MCP 配置。
