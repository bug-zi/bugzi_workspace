...
> **Spec:** `docs/project/左侧边栏/学习模块/文笔坊/designs-specs.md`（§0~§8）；需求正本同目录 `design.md`。
...
| `docs/project/左侧边栏/常驻模块/回收站/designs-specs.md` | 来源枚举同步 |
...
- Modify: `docs/project/左侧边栏/常驻模块/回收站/designs-specs.md`（来源枚举）
...
**Files:**
- Modify: `docs/project/左侧边栏/学习模块/文笔坊/designs-specs.md`（§4.1 措辞、§6 表补一行）
- Modify: `docs/log/260907.md`（追加小节）
- Modify: `docs/project/左侧边栏/学习模块/文笔坊/2026-09-07-文笔坊-design.md`（状态行）
...
- **依据**：`左侧边栏/学习模块/文笔坊/designs-specs.md`（260907 brainstorming → 立项 → specs 开发者审核通过）+ 实施计划 `左侧边栏/学习模块/文笔坊/2026-09-07-文笔坊.md` 按 Task 1-10 执行。
...
typecheck/build 通过后，将本 plan 与 spec `2026-09-07-文笔坊-design.md` 一并移入 `docs/project/左侧边栏/学习模块/文笔坊/archive/`（文件名不变；spec 状态行已含归档说明）。
