...
**Tech Stack:** Electron 44 + React 19 + TypeScript + node:sqlite + marked。设计文档：`docs/project/左侧边栏/学习模块/学习库/2026-09-12-学习库v2.0升级-design.md`（实施前先通读）。
...
`docs/project/左侧边栏/学习模块/学习库/2026-09-12-学习库v2.0升级-design.md`：
