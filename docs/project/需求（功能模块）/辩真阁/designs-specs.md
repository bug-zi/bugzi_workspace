...
> 本文档由 AI 基于 `docs/project/需求（功能模块）/辩真阁/design.md` 与《总需求文档.md》第 1、5、6、8 条生成，是开发的直接依据。依赖：样式/designs-specs.md 的 AI 边栏与 MdDialog、回收站/designs-specs.md 的接入约定、个人中心的 MCP 配置。
